...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.salkuadrat.learning.learning_text_recognition.LearningTextRecognitionPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin learning_text_recognition, com.salkuadrat.learning.learning_text_recognition.LearningTextRecognitionPlugin", e);
    }
    try {
